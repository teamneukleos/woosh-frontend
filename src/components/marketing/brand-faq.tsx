...
export function BrandFaq() {
  ...
  return (
    <section id="faq" className="border-t border-white/10 bg-black py-20 md:py-28">
            ...
            return (
              <div key={item.q} className="py-5">
                <button
                  ...
                  className="flex w-full cursor-pointer items-start justify-between gap-6 text-left text-[0.9375rem] font-medium text-white transition-colors hover:text-[#0de3af]"
                >
                  <span>
                ...
                <p
                  ...
                  hidden={!isOpen}
                  className={cn(
                    "mt-3 max-w-2xl origin-top pl-10 text-sm leading-6 text-white/50",
